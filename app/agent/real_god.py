...
- system_prompt: 第一人称扮演提示词。
  **重要说明**：由于底层系统已经内置了“角色宪法”（即“你是一个真实人类，不要自我介绍”等硬性边界），这里的 system_prompt 只需要包含角色的**特殊语言风格、口头禅和语气特征**（如“你习惯用反问句，带有轻微的学术傲慢”）。请**不要**在其中重复 bio 和 theories，也**不要**重复通用的 AI 约束指令。

【Action 样例】
Action: Search[2024年诺贝尔物理学奖得主]
Action: Finish[{{"name": "杰弗里·辛顿", "title": "AI教父", "bio": "...", "theories": ["深度信念网络", "反向传播"], "stance": "...", "system_prompt": "你说话时习惯使用复杂的比喻，语速较慢..."}}]
