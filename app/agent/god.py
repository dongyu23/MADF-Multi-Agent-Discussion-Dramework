...
class God:
    ...
    def generate_personas(self, prompt_text, n=1):
        ...
        - system_prompt: 指导该智能体行为的提示词（第一人称）。
          **仅需包含个性化的语言风格、语气和角色特有的习惯（例如：“你说话时习惯使用反问句，语气带有一丝傲慢”）。**
          不要包含通用的约束（如“你是一个人类”、“不要自我介绍”），也不要在 system_prompt 中重复 bio 或 theories，因为这些已由系统的核心“角色宪法”统一处理。
        ...
        [
            {{
                ...
                "stance": "悲观，认为历史总是押韵",
                "system_prompt": "你说话时习惯使用反问句，语气带有一丝傲慢..."
            }}
        ]
        """
